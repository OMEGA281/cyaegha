...
public class ERPG extends Father 
{
	...
	private final String[] ShortCrazy={
			...
			"不自觉地模仿旁人的动作",
			"奇怪的食欲（泥土、黏土、人肉）",
			"恍惚（像胎儿一样蜷缩起来，忘记一切）或紧张型精神分裂（对一切失去兴趣，必须有别人引导，否则无法进行任何独立行动）"};
	private final String[] LongCrazy= {
			"记忆缺失、健忘(症)或恍惚/紧张症（参见短期表）",
			"严重的恐惧症（可能逃跑，或将所有东西都看成害怕的东西）",
			"幻觉",
			"奇怪的性取向（裸露癖、女子淫狂/男子淫狂等）",
			"找到了某样“幸运符”（把某样饰品、器物甚至某人当作安全毯），如果远离就会一事无成",
			"无法控制地抽搐、颤抖，无法藉由语言或书写交谈","精神性的失明、失聪，或某个肢体无法使用",
