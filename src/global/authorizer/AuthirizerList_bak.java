...
public class AuthirizerList_bak 
{
	...
	protected AuthirizerList_bak(String path) throws JDOMException, IOException 
	{
		this.path=path;
...
//			FIXME:这里之后要加入一个由设置的默认值而影响的
	 ...
	 */
	protected int getPersonPermission(String name,long num)
	{
	 ...
	 * @return 返回数字：-1/在黑名单中；0/不存在于任何名单；1/在白名单中
	 */
	protected int getGroupPermission(String name,long num)
	{
	 ...
	 * @return 返回数字：-1/在黑名单中；0/不存在于任何名单；1/在白名单中
	 */
	protected int getDiscussPermission(String name,long num)
	{
	 ...
	 * @return 返回数字：-1/在黑名单中；0/不存在于任何名单；1/在白名单中
	 */
	protected int getGroupDetialedPermission(String name,long groupNum,long num)
	{
	 ...
	 * @return 返回数字：-1/在黑名单中；0/不存在于任何名单；1/在白名单中
	 */
	protected int getDiscussDetialedPermission(String name,long groupNum,long num)
	{
	...
	protected boolean hasPersonPermission(String name,long number)
	{
	...
	protected boolean hasGroupPermission(String name,long number)
	{
	...
	protected boolean hasDiscussPermission(String name,long number)
	{
	...
	protected boolean hasGroupDetailedPermission(String name,long groupNum,long number)
	{
	...
	protected boolean hasDiscussDetailedPermission(String name,long groupNum,long number)
	{
